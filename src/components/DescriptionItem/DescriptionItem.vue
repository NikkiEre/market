<template>
    <section class="description-item">
        <h5 class="description-item__category">
            {{ item.category }}
        </h5>

        <hr class="description-item__line_pink">
        ...
        <p class="description-item__price">
            ${{ item.price }}
        </p>

        <hr class="description-item__line_gray">
        ...
        <button class="description-item__button" @click="addToCartHandle">
            <svg 
  ...
  components: { FilterItem },
    ...
    methods: {
        addToCartHandle: function() {
            const itemWithParams = {...this.item, ...this.params};
            this.addToCart(itemWithParams);
        }
    }
}
</script>
